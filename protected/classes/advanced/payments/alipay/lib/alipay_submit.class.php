...
class AlipayMoblieSubmit {
    ...
    function AlipayMoblieSubmit($alipay_config) {
	...
	function buildRequestForm($para_temp, $method, $button_name) {
		...
		$sHtml = "<form id='AlipayMoblieSubmit' name='AlipayMoblieSubmit' action='".$this->alipay_gateway_new."_input_charset=".trim(strtolower($this->alipay_config['input_charset']))."' method='".$method."'>";
		...
		$sHtml = $sHtml."<script>document.forms['AlipayMoblieSubmit'].submit();</script>";
